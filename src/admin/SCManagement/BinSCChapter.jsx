...
const BinSCChapter = () => {
    ...
    const [scChapterData, setScChapter] = useState([]);
    ...
    const handleDeleteClick = async (oscaID) => {
        ...
        if (confirmDelete) {
            ...
            if (result.status === 1) {
                ...
                setScChapter(prevData => prevData.filter(item => item.oscaID !== oscaID));
